...
<head>
    ...
    <title>Contact_Us - FoodHuB</title>
    ...
    <div class="row justify-content-lg-center">
      <div class="col-12 col-lg-9">
        <div class="bg-white border rounded shadow-sm overflow-hidden">
          ...
          <form action="add_contact_us.php" method="post" enctype="multipart/form-data">
            <div class="row gy-4 gy-xl-5 p-4 p-xl-5">
              ...
              <div class="col-12">
                <div class="d-grid">
                  <input class="btn btn-primary btn-lg" name="save" value="Submit" type="submit"></input>
                </div>
              </div>
            </div>
          </form>
